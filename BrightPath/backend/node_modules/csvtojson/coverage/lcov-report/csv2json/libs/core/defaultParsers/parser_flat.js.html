...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js"><span class="cstat-no" title="statement not covered" >module.exports = {</span>
  ...
  "processSafe": true,
  "regExp": /^\*flat\*/,
  "parserFunc": function <span class="fstat-no" title="function not covered" >parser_flat </span>(params) {
     var key = <span class="cstat-no" title="statement not covered" >this.getHeadStr();</span>
     var val = <span class="cstat-no" title="statement not covered" >params.item;</span>
