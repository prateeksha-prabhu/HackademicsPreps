...
<span class="cstat-no" title="statement not covered" >module.exports = <span class="fstat-no" title="function not covered" >fu</span>nction(data, param) {</span>
  var eol = <span class="cstat-no" title="statement not covered" >getEol(data,param);</span>
  var lines = <span class="cstat-no" title="statement not covered" >data.split(eol);</span>
  var partial = <span class="cstat-no" title="statement not covered" >lines.pop();</span>
