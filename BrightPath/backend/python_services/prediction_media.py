...
model_path = os.path.abspath("python_services/dropout_model_media.pkl")
...
def get_prediction(student_data):
    """
    Predict whether a student is at risk of dropping out based on combined features.
    """
    try:
        # Extract features
        features = [
            ...
            student_data.get('social_media_usage_time', 0)
        ]
