...
const OnlineLearningPrediction = () => {
    ...
    return (
        <div className="container mx-auto p-6">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <h1 className="text-2xl font-bold flex-1 text-center">Online Learning Prediction</h1>
                <button
                        ...
                        {students.map((student) => (
                            <tr key={student.registerNumber} className="bg-white border hover:bg-gray-100">
                                ...
                                <td className="border p-3 text-center">
                                    ...
                                    >
                                        {loadingStudent === student.registerNumber ? <Loader2 className="animate-spin" size={16} /> : "Get Predictions"}
                                    </button>
                                </td>
                            </tr>
                        ))}
...
export default OnlineLearningPrediction;
